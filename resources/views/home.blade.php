...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-light accordion" id="accordionSidebar"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#laporanKecelakaan"
                    aria-expanded="true" aria-controls="laporanKecelakaan">
                    <i class="fas fa-fw fa-clipboard-list" style="color: black;"></i>
                    <span style="color: black;">Laporan</span>
                </a>
                <div id="laporanKecelakaan" class="collapse" aria-labelledby="headingTwo"
